...
print(f"""
         Dla produktu o identyfikatorze {product_id} dostępnych jest {reviews_count} opinii.
         Dla {pros_count} opinii autor podał listę zalet, a dla {cons_count} listę wad.
         Średnia ocen produktu to {product_rating:.1f}""")
